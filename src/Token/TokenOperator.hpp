...
const char *TokenOperatorType_strings[] = { "TOKEN_OPERATOR_ASSIGN",
                                            "TOKEN_OPERATOR_ASSIGN_ADD",
                                            "TOKEN_OPERATOR_ASSIGN_SUB",
                                            "TOKEN_OPERATOR_ASSIGN_MULT",
                                            "TOKEN_OPERATOR_ASSIGN_DIV",
...
/* TODO: fix lexer: `b - 1` is parsed as `IDENTIFIER LITERAL LITERAL`, should be `IDENTIFIER
 * OPERATOR LITERAL`, how is C++ doing it? */
