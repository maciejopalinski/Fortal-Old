...
const char *TokenLiteralType_strings[] = { "TOKEN_LITERAL_INT",  "TOKEN_LITERAL_DOUBLE",
                                           "TOKEN_LITERAL_CHAR", "TOKEN_LITERAL_STRING",
                                           "TOKEN_LITERAL_BOOL", "TOKEN_LITERAL_NULL" };
