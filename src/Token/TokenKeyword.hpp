...
const char *TokenKeywordType_strings[] = {
    "TOKEN_KEYWORD_IF",     "TOKEN_KEYWORD_ELSE",   "TOKEN_KEYWORD_FOR",   "TOKEN_KEYWORD_DO",
    "TOKEN_KEYWORD_WHILE",  "TOKEN_KEYWORD_RETURN", "TOKEN_KEYWORD_BREAK", "TOKEN_KEYWORD_CONTINUE",
    "TOKEN_KEYWORD_IMPORT", "TOKEN_KEYWORD_VOID",   "TOKEN_KEYWORD_INT"
};
...
vector<string> TokenKeyword::lexer_matches = { "if",     "else",   "for",   "do",
