...
const char *TokenBracketType_strings[] = { "TOKEN_BRACKET_PAREN_L",  "TOKEN_BRACKET_PAREN_R",
                                           "TOKEN_BRACKET_SQUARE_L", "TOKEN_BRACKET_SQUARE_R",
                                           "TOKEN_BRACKET_CURLY_L",  "TOKEN_BRACKET_CURLY_R" };
